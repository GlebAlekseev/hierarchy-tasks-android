...
class EditBoardItemUseCase(private val boardListRepository: BoardListRepository) {
    operator fun invoke(boardItem: BoardItem) = boardListRepository.editBoardItem(boardItem)
}